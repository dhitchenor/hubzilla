...
// As of version 11.4, if using connection pooling for your DB
// uncomment the line below, and ensure it is set to true
// App::\$config['system']['pdo_emulate_prepares'] = true;
