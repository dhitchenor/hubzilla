...
- on line 43, change `hub:9000` to match the name (not, container name) of your hubzilla container in your docker-compose.yml file
    ...
    ![hub_9000.png](https://raw.githubusercontent.com/dhitchenor/hubzilla/9.2/.github/images/hub_9000.png)
#### 3. Edit .env file
##### a) Locations
...
- change the `DB agnostic` options to reflect your desired database credentials
    ...
    ![hub_db.png](https://raw.githubusercontent.com/dhitchenor/hubzilla/9.2/.github/images/hub_db.png)
